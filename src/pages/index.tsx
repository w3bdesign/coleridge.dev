      ...
      <main className="container mx-auto flex flex-col items-start justify-start max-w-3xl mt-5">
        <div className="flex flex-col items-start justify-start leading-7 m-5">
          ...
          <p className="text-md text-gray-600 dark:text-gray-400 mt-2">
            ...
            from a young age on how technology works leading into designing and building meaningful
            applications for users. I&apos;m constantly trying to improve and expand my knowledge in
            the tech industry, and I&apos;m always looking for new opportunities to learn and grow.
          </p>

  ...
  return (
    <p className="text-black/50 dark:text-white/50 text-md mt-2">
      <p className="text-white font-semibold mb-5">
        ...
        leaving a message below. You can also contact me via <a href="https://coleridge.dev/twitter" target={"_blank"} rel={"noreferrer"} className="underline">Twitter</a> or <a href="https://coleridge.dev/discord" target={"_blank"} rel={"noreferrer"} className="underline">Discord.</a>
      </p>
      It&apos;s currently{" "}

...
const DiscordStatus = () => {
  ...
  if (data?.discord_status === "dnd") {
    return (
      <div className="flex flex-col items-start justify-center textxl font-semibold px-4 pl-3 pr-20 py-4 mt-5 text-white bg-red-500 rounded-lg transition ease-in-out hover:bg-gray-900">
        <h3>
        <span className="px-2">
          <DiscordLogo />
          </span>
